...
LOW_INK_THEME = SvgTheme(
    css=(
        ...
        ".corridor-outline{fill:none;stroke:#111;stroke-linejoin:round;stroke-linecap:square}"
        ".corridor{fill:none;stroke:#fff;stroke-linejoin:round;stroke-linecap:square}"
...
DRAFT_THEME = SvgTheme(
    css=(
        ...
        ".corridor-outline{fill:none;stroke:#777;stroke-linejoin:round}"
        ".corridor{fill:none;stroke:#fff;stroke-linejoin:round}"
