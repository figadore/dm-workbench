...
- **Working tree:** uncommitted completed P7-13b pure dungeon-engine changes, the prior P7-13a work, P7-13 planning documentation, and a user-directed model-gateway usage-normalization repair. No migration changed.
...
- **Working tree:** uncommitted P7-13a/P7-13b code, tests, status, planning changes, the user-directed gateway-usage repair, and user-directed P7-13d connection-mechanics/repair-outcome planning clarification; no migration changed.
...
- **Suggested commit subject:** `P7-12c propagate pi-ai usage through gateway`.
