...
- **Working tree:** uncommitted P7-13c renderer/annotation work atop the completed P7-13a/P7-13b work and prior planning/gateway changes. No migration changed.
...
- **Current task:** P7-13d — Doors, traps, puzzles, features, and a usable DM guide (not started).
- **First action:** freeze a new retained-artifact-safe compact design/compiler/package contract for the documented connection-mechanics matrix; do not alter V2 or the immutable `1.1.0` reader.
...
- **Working tree:** uncommitted P7-13a/P7-13b/P7-13c code, tests, status, planning changes, the user-directed gateway-usage repair, and user-directed P7-13d connection-mechanics/repair-outcome planning clarification; no migration changed.
- **Single next recommended task:** **P7-13d — Doors, traps, puzzles, features, and a usable DM guide.** **First concrete action:** write the retained-artifact-safe versioned proposal and package contract for composable same-floor doors and explicitly located vertical endpoint doors/hatches, including the full capability matrix.
- **Suggested commit subject:** `P7-13c add deterministic dungeon map callouts`.
