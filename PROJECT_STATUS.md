...
- **Current task:** P4-06 in progress; roadmap remains reprioritized from P3 canonical revisions to the standalone prompt-to-dungeon-package path.
- **Next task:** **P4-07 — General Ask web workflow and comparison baseline**.
...
- **Working tree:** `PROJECT_STATUS.md`, `src/dm_assistant/modules/__init__.py`, `src/dm_assistant/modules/modeling/__init__.py`, `src/dm_assistant/modules/modeling/contracts.py`, `src/dm_assistant/modules/modeling/workbench.py`, `src/dm_assistant/modules/preparation/__init__.py`, `src/dm_assistant/modules/preparation/contracts.py`, `src/dm_assistant/orchestration/__init__.py`, `src/dm_assistant/orchestration/modeling/__init__.py`, `src/dm_assistant/orchestration/modeling/service.py`, `src/dm_assistant/api/app.py`, `src/dm_assistant/web/routes.py`, `src/dm_assistant/web/templates/base.html`, `src/dm_assistant/web/templates/dungeons.html`, `src/dm_assistant/web/templates/model_panel.html`, `tests/unit/test_modeling_contracts.py`, `tests/unit/test_modeling_service.py`, and `tests/unit/test_web_auth.py` are modified. No user changes were reverted.
- **Next:** P4-07; reuse the settings and stream foundation for the general Ask workflow and comparison baseline.
- **Suggested commit:** `P4-06 add shared model workbench UI`.
